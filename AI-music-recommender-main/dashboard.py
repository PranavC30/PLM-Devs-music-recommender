...
def render_dashboard(agent):
    ...
    if not q_table:
        st.info("The Q-Table is currently empty. Start interacting with recommendations to train the AI.")
        return
    data = []
    ...
    st.write("This shows how strongly the AI associates different states with specific genres.")
