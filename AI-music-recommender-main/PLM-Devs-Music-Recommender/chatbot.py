...
class MusicChatbot:
    """Rule-based AI chatbot for natural language song requests."""
    ...
    def respond(self, user_input: str) -> dict:
        ...
        if 'surprise' in text or 'random' in text or 'kuch bhi' in text:
            return {"text": "🎲 Surprise! Yeh lo random picks:",
        ...
        responses = [f"🎵 Yeh lo {label} songs!", f"Found some great {label} tracks for you 🎧", f"Here are your {label} picks ✨"]
